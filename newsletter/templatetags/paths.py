...
def paragraph_markup(text):
    new_text = re.sub(r"<p[^>]*>", "<p style=\"-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: \'Droid Serif\', Georgia, serif; margin-bottom: 5px; font-size: 16px; line-height: 120%\">", text, 0)
