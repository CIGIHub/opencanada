    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploaded_by_user', models.ForeignKey(blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='Uploaded by user', on_delete=django.db.models.deletion.SET_NULL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(related_name='renditions', to='images.AttributedImage', on_delete=django.db.models.deletion.CASCADE)),
            ],
        ),
