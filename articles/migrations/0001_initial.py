    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('sort_order', models.IntegerField(null=True, editable=False, blank=True)),
                ('override_text', wagtail.core.fields.RichTextField(default='', help_text='This field is optional. If not provided, the text will be pulled from the article page automatically. This field allows you to override the automatic text.', blank=True)),
        ...
        migrations.AddField(
            ...
            name='topic',
            field=models.ForeignKey(related_name='article_links', on_delete=django.db.models.deletion.CASCADE, to='articles.Topic'),
        ),
        migrations.AddField(
